...
function printReport(data: TotalWarehouse) {
	...
	// 	if(Object.values(data)[i] === 'empty') {
	// 		title += Object.keys(data)[i] + ', ';
	// 	}
	// }
	// console.log(title)
	return `We need this items: ${Object.keys(data).reduce((acc, curr, currentIndex) => Object.values(data)[currentIndex] === "empty" ? acc + curr + ", " : acc , '').slice(0, -2)}`;
	// или
